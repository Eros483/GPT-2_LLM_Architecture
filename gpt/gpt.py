...
import tiktoken
from src.data_handling import LLM_Dataset_v1, create_dataloader_v1
from src.multihead_attention import MultiHeadAttention
from src.misc import LayerNorm, GELU, FeedForward
...
def main():
    ...
    print(f"\n{50*'='}\n{22*' '}Device used is {device}\n{50*'='}")
    model.to(device)
    model.eval()

    print(f"\n{50*'='}\n{22*' '}USER QUESTION\n{50*'='}")
    question=input("Ask for question: ")
